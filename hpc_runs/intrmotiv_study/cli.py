...
def command_collect_online(args: argparse.Namespace) -> None:
    ...
    manifest["collection"] = {
        ...
        "scalar_size_guidance": 0 if args.latest_common or args.export_histories else study.analysis.get("scalar_size_guidance", 30000),

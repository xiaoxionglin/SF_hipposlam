...
RUN_DESCRIPTION = RunDescription(
    ...
    experiments=[
        make_experiment(Cell("delayed", 16), 8, train_for_env_steps=5_000_000, prefix="PF", group_suffix="preflight", batch_name=BATCH_NAME),
        make_experiment(Cell("immediate", 64), 123, train_for_env_steps=5_000_000, prefix="PF", group_suffix="preflight", batch_name=BATCH_NAME),
    ],
)

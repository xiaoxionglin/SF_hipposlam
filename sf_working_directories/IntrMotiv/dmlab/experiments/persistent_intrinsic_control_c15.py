"""Exact original-C15 continuation arm for the persistent-control study."""
...
def build(run):
    ...
    command = original.cmd.replace(
        ...
        "--wandb_group=intrmotiv_corrected_core_reevaluation_20260901_pic_c15_20260908",
...
RUN_DESCRIPTION = RunDescription(STUDY.batch_name, experiments=[build(run) for run in STUDY.expand_runs()])

...
from sf_working_directories.jannek.dmlab.dmlab30 import DMLAB_INSTRUCTIONS, DMLAB_VOCABULARY_SIZE

from sf_working_directories.jannek.dmlab.dmlab_model import DmlabEncoder
